About psycogreen-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/psycogreen-feedstock/blob/main/LICENSE.txt)
...
Development: https://bitbucket.org/dvarrazzo/psycogreen

Documentation: https://bitbucket.org/dvarrazzo/psycogreen
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5975&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/psycogreen-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `psycogreen` can be installed with `conda`:
...
```
mamba install psycogreen
```

It is possible to list all of the versions of `psycogreen` available on your platform with `conda`:
...
```
mamba search psycogreen --channel conda-forge
```
...
mamba repoquery search psycogreen --channel conda-forge

# List packages depending on `psycogreen`:
mamba repoquery whoneeds psycogreen --channel conda-forge

# List dependencies of `psycogreen`:
mamba repoquery depends psycogreen --channel conda-forge
```
